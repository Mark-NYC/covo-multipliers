...
values (
  ...
  'An interactive disciple-making and church-planting training through the Kingdom clear path to multiply disciples and churches — with a strong focus on leaders making disciples in the fields where they live, work, and play. Leave with a Biblical foundation for the principles, process, and tools to see growing disciples, healthy churches, and maturing leaders in any context.',
  'A 3-day live training to multiply disciples and churches where you live, work, and play.',
